...
class LocalMb2builderEditor
{
	...
	static function local_mb2builder_get_input_editor()
	{
		...
		$output .= '<div class="mb2-pb-editor-toolbar">';
		...
		$output .= '</div>'; //mb2-pb-editor-toolbar
		//htmlmode
	...
	static function local_mb2builder_get_input_editor_helper_image()
	{
		...
		$output .= ' <button type="button" class="mb2-pb-image-select color-success" data-toggle="modal" data-target="#mb2-pb-modal-images">' .
		get_string('selectimage','local_mb2builder') . '</button>';
		$output .= '</p>';
		$output .= '<p>';
		...
		$output .= '<button type="button" class="mb2-pb-editor-image-save color-success">' . get_string( 'save', 'admin' ) . '</button> | ';
		$output .= '<button type="button" class="mb2-pb-editor-image-remove color-danger">' . get_string( 'remove' ) . '</button> | ';
		$output .= '<button type="button" class="mb2-pb-editor-image-cancel color-danger">' . get_string( 'cancel' ) . '</button>';
		$output .= '</div>';
		$output .= '</div>';
	...
	static function local_mb2builder_get_input_editor_helper_link()
	{
		...
		$output .= '</p>';
		$output .= '<div class="element-image-buttons">';
		$output .= '<button type="button" class="mb2-pb-editor-link-save color-success">' . get_string('save', 'admin') . '</button> | ';
		$output .= '<button type="button" class="mb2-pb-editor-link-cancel color-danger">' . get_string('cancel') . '</button>';
		$output .= '</div>';
		$output .= '</div>';
