		...
		public static function get_import_blocks_list( $layout = false )
		{
			...
			foreach ( $blocks as $block )
			{
				...
				foreach ( $blocksettings['items'] as $k => $item )
				{
					...
					$output .= '<a class="mb2-pb-import-part" href="#" data-fbuilder="' . $fbuilder . '" data-part="' . $part . '" data-tags="' . $item['tags'] . '" data-category="' . $blocksettings['id'] . '" data-itemid="' . $k . '" data-dismiss="modal" title="' . get_string('import', 'local_mb2builder') . '">';
