...
class service_edit_form extends moodleform {
    ...
    protected function definition()
    {
        ...
        $langArr = array_merge(array('' => get_string('all')), get_string_manager()->get_list_of_translations());
        ...
        $mform->addElement('select', 'language', get_string('language'), $langArr);
        $mform->getElement('language')->setMultiple(true);
        $mform->setDefault('language', ['']);
        
        $mform->addElement('html', '<div style="height:1.2rem;"></div>');
        $mform->addElement('html', '<div class="mb2tmpl-accc"><button type="button" class="mb2tmpl-acc-title">' . 
                           get_string('settingsstyledd', 'local_mb2megamenu') . '</button><div class="mb2tmpl-acccontent"><div>');
        ...
        $mform->addElement('html', '<div class="mb2tmpl-accc"><button type="button" class="mb2tmpl-acc-title">' . 
                           get_string('settingsstyleheading', 'local_mb2megamenu') . '</button><div class="mb2tmpl-acccontent"><div>');
        ...
        $mform->addElement('html', '<div class="mb2tmpl-accc"><button type="button" class="mb2tmpl-acc-title">' . 
                           get_string('settingsstylmobile', 'local_mb2megamenu') . '</button><div class="mb2tmpl-acccontent"><div>');
